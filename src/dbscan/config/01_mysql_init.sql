...
CREATE DATABASE IF NOT EXISTS dbscan_test_schema CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE dbscan_test_schema;
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    phone VARCHAR(20) COMMENT '收货手机号',
...
CREATE TABLE IF NOT EXISTS accounts (
    ...
    user_id BIGINT NOT NULL,
    id_card VARCHAR(18) COMMENT '身份证号',
    bank_card VARCHAR(25) COMMENT '银行卡号',
...
-- 插入用户表数据
INSERT INTO users (name, id_card, phone, email, address) VALUES
...
('孙七', '110101199401015678', '18612345678', 'sunqi@example.com', '北京市东城区'),
...
-- 插入订单表数据
INSERT INTO orders (user_id, order_no, phone, address, amount, status) VALUES
...
-- 插入账户表数据
INSERT INTO accounts (user_id, id_card, bank_card, bank_name, account_holder) VALUES
...
-- 插入日志表数据
INSERT INTO logs (user_id, phone, email, action, detail) VALUES
